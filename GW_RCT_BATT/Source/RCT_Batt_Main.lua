--[[
	...
	Localisation-file has to be as /Apps/RCT_BATT/lang/xx/locale.jsn
...
local function setLanguage()
  ...
  local file = io.readall("Apps/RCT_Batt/lang/"..lng.."/locale.jsn")
...
setLanguage()
--------------------------------------------------------------------
local RCT_Batt_Main = {init,loop}
return RCT_Batt_Main
